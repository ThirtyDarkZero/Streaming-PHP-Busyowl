...
function endpoint_unlike( $loader, $excuter, $args ){
    ...
    if ( $object_item ){
      ...
      if ( $loader->object->ugc_property->select( $array ) ){
        ...
        if ( $loader->object->db_setting->get("sl_gg_extra") && $loader->object->db_setting->get("sl_gg_id") && $loader->object->db_setting->get("sl_gg_secret") && $yt_id && $yt_key ){
          ...
          $google_tokens_coded = $loader->user->get()->data["extraData_decoded"]["google_token"];
          if ( !empty( $userLiveData["extraData_decoded"]["google_token"] ) ){
            ...
            try {
              ...
              $loader->google_api_helper->setTokens( $google_tokens )->setKey( $yt_key )->likeVideo( $yt_id, "none" );
            } catch( Exception $err ){
                $loader->api->set_error( "yt_unlike_failed", [ "reason" => $err->getMessage() ] );
            }
          }
        }
  ...
  $loader->api->set_message( "unliked" );
