...
INSERT IGNORE INTO _bof_setting( var, val ) VALUES ( 'admin_nu_lock', 1 );
INSERT IGNORE INTO _bof_setting( var, val ) VALUES ( 'admin_ti_lock', '' );
INSERT IGNORE INTO _bof_setting( var, val ) VALUES ( 'admin_ua_lock', 1 );
INSERT IGNORE INTO _bof_setting( var, val ) VALUES ( 'admin_ip_lock', 1 );

INSERT IGNORE INTO `_d_languages_items` ( `hook`, `lang_code2`, `text` ) VALUES ( 'manager_help', 'en', 'Hello dear manager! <br><br>\r\n\r\nClick <a href=\'user_edit?tab=transactions\'>here</a> to see transactions. Alternatively, you can use your email & password to see statistics in <a target=\'_blank\' href=\'%web_address%admin\'>admin-panel %icon%</a> or <a href=\'%web_address%user_withdraw\'>request a withdrawal %icon%</a><br><br>\r\nYou can use the form to claim another creator' );
INSERT IGNORE INTO `_d_languages_items` (`hook`, `lang_code2`, `text`) VALUES ('__all__', 'en', 'All');
INSERT IGNORE INTO `_d_languages_items` (`hook`, `lang_code2`, `text`) VALUES ('less_than_min', 'en', 'Failed: Minimum amount: %min%');
INSERT IGNORE INTO `_d_languages_items` (`hook`, `lang_code2`, `text`) VALUES ('preview', 'en', 'preview');
INSERT IGNORE INTO `_d_languages_items` (`hook`, `lang_code2`, `text`) VALUES ('view_rss_feed', 'en', 'RSS feed');


CREATE TABLE `_bof_cache_source_request` (
...
ALTER TABLE `_bof_cache_source_request` ADD `result_sta` INT NOT NULL AFTER `result`;
ALTER TABLE `_bof_cache_source_request` CHANGE `result_sta` `result_sta` INT NULL DEFAULT NULL;
ALTER TABLE `_bof_cache_source_request` ADD `endpoint` VARCHAR(100) NOT NULL AFTER `user_id`, ADD INDEX (`endpoint`);
ALTER TABLE `_bof_cache_source_request` ADD INDEX (`hash`, `time_add`, `endpoint`) USING BTREE;

INSERT IGNORE INTO `_d_languages_items` (`hook`, `lang_code2`, `text`) VALUES ('skip', 'en', 'skip');
INSERT IGNORE INTO `_d_languages_items` (`hook`, `lang_code2`, `text`) VALUES ('sponsor', 'en', 'sponsor');
INSERT IGNORE INTO `_d_languages_items` (`hook`, `lang_code2`, `text`) VALUES ('visit', 'en', 'visit');
INSERT IGNORE INTO `_d_languages_items` (`hook`, `lang_code2`, `text`) VALUES ('normal', 'en', 'normal');
INSERT IGNORE INTO `_d_languages_items` (`hook`, `lang_code2`, `text`) VALUES ('shuffle', 'en', 'shuffle');
INSERT IGNORE INTO `_d_languages_items` (`hook`, `lang_code2`, `text`) VALUES ('repeat', 'en', 'repeat');
INSERT IGNORE INTO `_d_languages_items` (`hook`, `lang_code2`, `text`) VALUES ('speed', 'en', 'speed');
INSERT IGNORE INTO `_d_languages_items` (`hook`, `lang_code2`, `text`) VALUES ('source', 'en', 'source');
INSERT IGNORE INTO `_d_languages_items` (`hook`, `lang_code2`, `text`) VALUES ('volume', 'en', 'volume');
INSERT IGNORE INTO `_d_languages_items` (`hook`, `lang_code2`, `text`) VALUES ('infinite', 'en', 'infinite');
INSERT IGNORE INTO `_d_languages_items` (`hook`, `lang_code2`, `text`) VALUES ('close', 'en', 'close');
INSERT IGNORE INTO `_d_languages_items` (`hook`, `lang_code2`, `text`) VALUES ('right_now', 'en', 'right now');

INSERT IGNORE INTO `_bof_setting` (`var`, `val`) VALUES ('ads_video_c_f', '0.5');
INSERT IGNORE INTO `_bof_setting` (`var`, `val`) VALUES ('ads_video_v_f', '0.1');
INSERT IGNORE INTO `_bof_setting` (`var`, `val`) VALUES ('ads_youtube_c_f', '0.5');
INSERT IGNORE INTO `_bof_setting` (`var`, `val`) VALUES ('ads_youtube_v_f', '0.1');

INSERT IGNORE INTO `_bof_setting` (`var`, `val`) VALUES('ad_interval', '5');
INSERT IGNORE INTO `_bof_setting` (`var`, `val`) VALUES('ad_offset', '5');
INSERT IGNORE INTO `_bof_setting` (`var`, `val`) VALUES('ad_skippability', '1');
INSERT IGNORE INTO `_bof_setting` (`var`, `val`) VALUES('ad_skippability_threshold', '10');
INSERT IGNORE INTO `_bof_setting` (`var`, `val`) VALUES('muse_rec_thres', '10');

ALTER TABLE `_bof_currencies` CHANGE `iso_code` `iso_code` VARCHAR(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL;
ALTER TABLE `_u_payments` ADD `gateway_req_data` MEDIUMTEXT NULL DEFAULT NULL AFTER `gateway_id`;
ALTER TABLE `_bof_log_cronjob_g` CHANGE `code` `code` VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL;

INSERT IGNORE INTO `_bof_setting` (`var`, `val`) VALUES('admin_color2', '51459d');
INSERT IGNORE INTO `_bof_setting` (`var`, `val`) VALUES('admin_color2_rgb', '81, 69, 157');
INSERT IGNORE INTO `_bof_setting` (`var`, `val`) VALUES('admin_color', 'fd961b');
INSERT IGNORE INTO `_bof_setting` (`var`, `val`) VALUES('admin_color_rgb', '253, 150, 27');
